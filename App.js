...
import {
  ...
  Text, //texto
  Image, //imagem
  TextInput, //caixa de input (entrada)
  TouchableOpacity, //botão
  StyleSheet, //style da página
  SafeAreaView, //é como se fosse estabelecer um limite para o conteúdo da tela
} from "react-native";
...
function LoginScreen({ navigation }) {
  ...
  return (
    <SafeAreaView style={{ flex: 1, alignItems: "center", justifyContent: "center" }}>
      <Image style={styles.img} source={require("./assets/logo-empresa.png")} />
